...
impl int: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::int::str(*self) }
}
impl i8: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::i8::str(*self) }
}
impl i16: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::i16::str(*self) }
}
impl i32: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::i32::str(*self) }
}
impl i64: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::i64::str(*self) }
}
impl uint: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::uint::str(*self) }
}
impl u8: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::u8::str(*self) }
}
impl u16: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::u16::str(*self) }
}
impl u32: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::u32::str(*self) }
}
impl u64: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::u64::str(*self) }
}
impl float: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::float::to_str(*self, 4u) }
}
impl f32: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::float::to_str(*self as float, 4u) }
}
impl f64: ToStr {
    #[inline(always)]
    pure fn to_str(&self) -> ~str { ::float::to_str(*self as float, 4u) }
