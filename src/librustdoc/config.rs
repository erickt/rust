...
fn config_from_opts(
    ...
    let result = do result.chain_move |config| {
    ...
    let result = do result.chain_move |config| {
        ...
        do output_format.map_move_default(result::Ok(config.clone())) |output_format| {
            do parse_output_format(output_format).chain_move |output_format| {
                result::Ok(Config {
    ...
    let result = do result.chain_move |config| {
        ...
        do output_style.map_move_default(result::Ok(config.clone())) |output_style| {
            do parse_output_style(output_style).chain_move |output_style| {
                result::Ok(Config {
    ...
    let result = do result.chain_move |config| {
        ...
        do pandoc_cmd.chain_move |pandoc_cmd| {
            result::Ok(Config {
